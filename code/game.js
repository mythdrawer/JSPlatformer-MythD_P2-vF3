...
//Invaders has Pos, size and woobble
...
Invader.prototype.type = "invader";
...
Invader.prototype.act = function(step, level) {
  this.wobble += step * wobbleSpeed;
  var wobblePos = Math.sin(this.wobble) * wobbleDist;
this.pos = this.basePos.plus(new Vector(0, wobblePos));
};
...
var wobbleSpeed = 18, wobbleDist = 0.08;

Invader.prototype.act = function(step) {
  this.wobble += step * wobbleSpeed;
  var wobblePos = Math.sin(this.wobble) * wobbleDist;
  this.pos = this.basePos.plus(new Vector(0, wobblePos));
};
